...
import ckimage1 from "../../static/kaffebarer-kobenhavn.jpg";
import ckexample1 from "../../static/kaffebarer-kobenhavn/kaffebarer-kobenhavn-1.jpg";
import ckexample2 from "../../static/kaffebarer-kobenhavn/kaffebarer-kobenhavn-2.jpg";
import ckexample3 from "../../static/kaffebarer-kobenhavn/kaffebarer-kobenhavn-3.jpg";
  ...
  return (
    <div className="landing-container">
      <Seo
        ...
        description="Bedste kaffesteder i København - her er dit overblik. Kaffebarer og caféer er udvalgt for deres gode kaffe, service og stemning. Vi besøger alle steder løbende."
      />
      ...
      <div className="landing-content">
        ...
        <p>
          ...
          det rigtige sted. På vores site finder du alle de bedste kaffebarer og
          ...
          en god kaffeoplevelse i byen. Du kan finde mange forskellige
          kaffebarer og på vores interaktive kort se hvor du finder dem. Det gør
          det også nemt, hvis der er en bydel hvor du helst vil nyde din kaffe.
        </p>
        ...
        <p>
          ...
          Desuden har byen en stor variation af kaffebarer, der tilbyder
        ...
        <p>
          ...
          innovativ tilgang til kaffe, hvilket gør det muligt for kaffebarerne
          at tilbyde et bredt udvalg af spændende og lækre kaffedrikke.
        </p>
        <p>
          Det er svært at sige, hvilken bydel i København der har de bedste
          kaffesteder, da der er mange gode kaffebarer i byen. Der er gode
          ...
          populære og hyggelige kaffebarer. Men som sagt, der er mange gode
